...
Just open `index.html` in a browser (double-click it, or right-click → Open with → your browser). Sign up with your email/password, and try adding a salary, a fixed expense, and a daily expense.
...
Open the resulting URL on your phone and log in with the same email/password — your data will be there because it's stored in Supabase, not the browser.
